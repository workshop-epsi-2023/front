      ...
      <div className="px-4 py-12 bg-white">
        <div className="mx-auto flex justify-center">
          <div className="relative">
            ...
            <div>
              <svg className="absolute top-[22px] right-[26px] animate-spin" width={113} height={113} viewBox="0 0 113 113" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <p className="text-center text-gray-600 text-base mt-4">Your Request Is Being Loaded, Please Wait</p>
      </div>
    </div>
  )
}
